...
if is_available "bufferline.nvim" then
  ...
  map("n", "<S-t>", "<cmd>BufferLinePick<cr>", { desc = "Pick buffer" })
  map("n", "<S-q>", "<cmd>BufferLinePickClose<cr>", { desc = "Pick buffer to close" })
else
...
-- Hop
map("n", "wF", "<cmd>HopWord<CR>")
map("n", "F", "<cmd>HopChar1<CR>")
map("n", "tF", "<cmd>HopChar2<CR>")
map("v", "wF", "<cmd>HopWord<CR>")
map("v", "F", "<cmd>HopChar1<CR>")
map("v", "tF", "<cmd>HopChar2<CR>")
