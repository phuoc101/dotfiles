...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "cmp-nvim-lsp", "cmp-buffer", "cmp_luasnip", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'Comment.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'null-ls.nvim', 'nvim-colorizer.lua', 'indent-o-matic'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'FixCursorHold.nvim', 'Comment.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'null-ls.nvim', 'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
